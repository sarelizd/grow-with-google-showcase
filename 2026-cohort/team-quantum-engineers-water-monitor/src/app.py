...
with tab_quality:
    ...
    st.info(
        ...
        "Risk* is the surrounding region's Cholera/Typhoid/Diarrheal case rate — a public-"
        "health signal, not a water-test result. A row can show **Safe** water and a "
        "**High** disease indicator at the same time: the water sample passed its checks, "
        "but the region still carries a high case rate from other causes (storage, "
        "distribution, sanitation, a past outbreak). This is expected, not an error."
    )

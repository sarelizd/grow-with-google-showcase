...
with tab_quality:
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "pH Level": st.column_config.NumberColumn(width="small"),
            # These four only ever hold short numbers (e.g. "2.410000"), so
            # "small" is plenty — "medium" was wasting horizontal space and
            # pushing Contaminant Level (and everything after it) off the
            # right edge, out of view without scrolling.
            "Turbidity (NTU)": st.column_config.NumberColumn(width="small"),

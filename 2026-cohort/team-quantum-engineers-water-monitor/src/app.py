...
with tab_quality:
    ...
    st.caption(
        "Elsewhere, the disease named is whichever of Cholera, Typhoid, or Diarrheal has the highest "
        "incidence in that row relative to this dataset."
    )
    ...
    st.markdown(
        ...
        <div class="action-grid">
            ...
            <div class="glass-card action-card">
                ...
                <div class="action-copy">
                    A water sample that's Safe doesn't rule out a regional disease signal. Whenever
                    Disease Indicator / Risk names any concern, such as a Cholera/Typhoid/Diarrheal
